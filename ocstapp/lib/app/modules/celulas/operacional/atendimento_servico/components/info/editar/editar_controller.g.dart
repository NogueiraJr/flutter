...
part of 'editar_controller.dart';
...
mixin _$AtendimentoServicoInfoEditarController
    on _AtendimentoServicoInfoEditarControllerBase, Store {
  ...
  final _$idAtom = Atom(name: '_AtendimentoServicoInfoEditarControllerBase.id');
  ...
  final _$atendimentoServicoIdAtom = Atom(
      name: '_AtendimentoServicoInfoEditarControllerBase.atendimentoServicoId');
  ...
  final _$descricaoAtom =
      Atom(name: '_AtendimentoServicoInfoEditarControllerBase.descricao');
  ...
  final _$tagsAtom =
      Atom(name: '_AtendimentoServicoInfoEditarControllerBase.tags');
  ...
  final _$observacaoAtom =
      Atom(name: '_AtendimentoServicoInfoEditarControllerBase.observacao');
  ...
  final _$_tagsFutureAtom =
      Atom(name: '_AtendimentoServicoInfoEditarControllerBase._tagsFuture');
  ...
  final _$tagsModelAtom =
      Atom(name: '_AtendimentoServicoInfoEditarControllerBase.tagsModel');
  ...
  final _$tagsToSaveAtom =
      Atom(name: '_AtendimentoServicoInfoEditarControllerBase.tagsToSave');
  ...
  final _$errorMessageAtom =
      Atom(name: '_AtendimentoServicoInfoEditarControllerBase.errorMessage');
  ...
  final _$_cadFutureAtom =
      Atom(name: '_AtendimentoServicoInfoEditarControllerBase._cadFuture');
  ...
  final _$_AtendimentoServicoInfoEditarControllerBaseActionController =
      ActionController(name: '_AtendimentoServicoInfoEditarControllerBase');

  @override
  dynamic changeDescricao(String descricaoValue) {
    final _$actionInfo =
        _$_AtendimentoServicoInfoEditarControllerBaseActionController
            .startAction();
    try {
