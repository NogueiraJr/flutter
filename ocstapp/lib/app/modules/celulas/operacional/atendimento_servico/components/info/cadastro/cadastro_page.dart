...
class AtendimentoServicoInfoCadastroPage extends StatefulWidget {
  final String title;
  const AtendimentoServicoInfoCadastroPage({Key key, this.title = "Cadastro"})
      : super(key: key);

  @override
  _AtendimentoServicoInfoCadastroPageState createState() =>
      _AtendimentoServicoInfoCadastroPageState();
}

class _AtendimentoServicoInfoCadastroPageState extends ModularState<
    AtendimentoServicoInfoCadastroPage,
    AtendimentoServicoInfoCadastroController> with LoaderMixin {
  ...
  // var AtendimentoServicoInfoCadastroController =
  //     GetIt.I.get<AtendimentoServicoInfoCadastroController>();
  ...
  _popularVarComDadosDoParametro() {
    final atendimentoServicoId = Get.args(context)['atendimentoServicoId'];
    controller.atendimentoServicoId = atendimentoServicoId;
    return atendimentoServicoId;
  }
}
