...
mixin _$AtendimentoServicoCalendarioController
    on _CalendarioControllerBase, Store {
  final _$valueAtom = Atom(name: '_CalendarioControllerBase.value');
  ...
  void increment() {
    final _$actionInfo =
        _$_CalendarioControllerBaseActionController.startAction();
    try {
