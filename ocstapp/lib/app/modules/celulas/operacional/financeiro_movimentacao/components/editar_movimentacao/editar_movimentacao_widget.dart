...
import 'editar_movimentacao_controller.dart';

class EditarMovimentacaoWidget extends StatelessWidget {
  final MovimentacaoModel item;
  final EditarMovimentacaoController controller;
  // final controller = Modular.get<EditarMovimentacaoController>();

  const EditarMovimentacaoWidget({
    Key key,
    this.item,
    this.controller,
  }) : super(key: key);
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Align(
                    ...
                    child: FlatButton(
                      onPressed: () async {
                        var _data = controller.dataInclusao;
                ...
                Visibility(
                  visible: item.atendimentoServico.id == 0,
                  child: Column(
                    children: <Widget>[
                      Container(
                        ...
                        child: ListCombo(
                          child: Padding(
                            ...
                            child:
                                Text(controller.categoria?.nome ?? 'Categoria'),
                          ),
