...
class FornecedorEditarPage extends StatefulWidget {
  final String title;
  const FornecedorEditarPage({Key key, this.title = "Editar"})
      : super(key: key);

  @override
  _FornecedorEditarPageState createState() => _FornecedorEditarPageState();
}

class _FornecedorEditarPageState
    extends ModularState<FornecedorEditarPage, FornecedorEditarController>
    with LoaderMixin {
  ...
  var fornecedorController = GetIt.I.get<FornecedorController>();
  ...
  void dispose() {
    ...
    GetIt.I.unregister<FornecedorModel>();
  }
    ...
    return Container(
      child: Tags(
        ...
        textField: TagsTextField(
            ...
            suggestions: fornecedorController.tagsModel,
      ...
      child: Stack(
        ...
        children: <Widget>[
          Positioned(
            ...
            bottom: 70,
            child: Image.asset(
              'assets/images/dds-fornecedores.png',
            ),
          ),
          Positioned(
            bottom: 28,
  ...
  Form _makeForm() {
    fornecedorController.obterTags();
        ...
        child: Column(
          children: <Widget>[
            ...
            AppTextFormField(
              ...
              controller: controller.controllerMaskTelefone,
              icon: Icons.account_circle,
              onChanged: (String valor) =>
                  controller.changeTelefone(valor.trim()),
              validator: (String valor) {
                if (valor.trim().isEmpty ||
                    valor.trim().length != valor.length) {
                  return 'Obrigatório, formato número de telefone';
                }
                return null;
              },
            ...
            Observer(
              builder: (_) {
                switch (fornecedorController.tagsState) {
            ...
            AppFlatButton(
              label: 'Gravar',
              onPressed: () => controller.gravarFornecedor(),
            ),
            SizedBox(height: 10),
          ],
        ),
