...
import 'fornecedor_cadastro_controller.dart';

class FornecedorCadastroPage extends StatefulWidget {
  final String title;
  const FornecedorCadastroPage({Key key, this.title = "Cadastro"})
      : super(key: key);
...
class _FornecedorCadastroPageState
    extends ModularState<FornecedorCadastroPage, FornecedorCadastroController>
    with LoaderMixin {
