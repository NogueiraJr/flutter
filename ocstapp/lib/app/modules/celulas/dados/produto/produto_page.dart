...
import 'package:OCSTApp/app/modules/celulas/dados/produto/blocos/blocos_dados_lanchonete/blocos_dados_lanchonete_widget.dart';
import 'package:OCSTApp/app/modules/celulas/dados/produto/blocos/blocos_dados_locacao_roupas/blocos_dados_locacao_roupas_widget.dart';
import 'package:OCSTApp/app/modules/celulas/dados/produto/blocos/blocos_dados_oficina_carros/blocos_dados_oficina_carros_widget.dart';
...
class ProdutoPage extends StatefulWidget {
  final String title;
  const ProdutoPage({Key key, this.title = "Produtos"}) : super(key: key);
...
class _ProdutoPageState extends ModularState<ProdutoPage, ProdutoController> {
  ...
  ProdutoController controller = Modular.get<ProdutoController>();
  ...
  void initState() {
    ...
    super.initState();
    _disposer ??= [];
    if (GetIt.I.isRegistered<ProdutoController>()) {
      GetIt.I.unregister<ProdutoController>();
    }
    GetIt.I.registerSingleton<ProdutoController>(controller);
  }
